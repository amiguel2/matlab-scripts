 ...
 * File: _coder_get_startlen_info.c
 *
...
/* Include Files */
#include "_coder_get_startlen_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("get_startlen"));
...
/*
 * File trailer for _coder_get_startlen_info.c
 *
 * [EOF]
 */
