function [fdist,ftime_interval] = length_diff_contourfile(contour_file,length_limit,exclude_t,roc_on)
% load contour file
...
for i = 1:numel(f.cell)%numel(good_cells)
    cellid = i; %good_cells(i);
